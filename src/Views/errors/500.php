<div class="container" style="margin-top: 120px; text-align: center; padding: 60px 20px;">
    <div style="font-size: 120px; font-weight: 700; color: var(--warning, #f59e0b); line-height: 1;">500</div>
    <h2 style="margin: 20px 0 10px; color: var(--text);"><?= __('error.server_error') ?></h2>
    <p style="color: var(--text-muted); max-width: 500px; margin: 0 auto 30px;">
        <?= e($message ?? __('error.server_error_desc')) ?>
    </p>
